...
const showFlights = () =>{
  ...
  let today = new Date()
  console.log('Los vuelos programados para el día de hoy '+ today +' son los siguientes:' )
  console.log('-----------------------------------------------------')
...
console.log('El coste medio de los vuelos de hoy es de ' + average + ' euros.' )
}}
...
function lastMinFlights (){
 lastMinFlights = confirm('Si solamente puede volar en los últimos vuelos del día, ¿desearía ver los destinos de los 5 últimos vuelos de nuestra compañía?')
 if(lastMinFlights === true){
 console.log(`Los destinos de los 5 últimos vuelos para el día de hoy son: ${flights[4].to}, ${flights[5].to}, ${flights[6].to}, ${flights[7].to}, ${flights[8].to} y  ${flights[9].to}.`)
 }
}
...
function userFunctions(){
  const userPrice = prompt('Si desea buscar por precio, por favor, introduzca un precio y le mostraremos los vuelos disponibles con ese precio o más baratos.')
...
if(suitableFlights.length >0){
  console.log('-----------------------------------------------------')
  console.log('Los vuelos programados con ese precio o más baratos son los siguientes:' )
  ...
  console.log('Lo sentimos, no hay vuelos disponibles por ese precio para el día de hoy.')
}
}
...
function deleteFlights (){
  ...
  if(deleteFlight ===true){
    ...
    alert('Ha eliminado el vuelo con origen ' + flights[i].from +' y destino a ' + flights[i].to + '.' )
    flights.splice(i, 1)
    deleteFlights()
    }else{
 ...
 function sayByeUser (){
   alert('Gracias por usar esta aplicación, ¡Anaya Airlines estará encantando de volar con usted próximamente!')
 }

function sayByeAdmin (){
   alert('Si quiere volver a realizar cambios reinicie la aplicación. Hasta luego!')
 }
