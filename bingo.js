...
const generateCarton = () => {
  ...
  alert(
    userName +
      " su cartón en este turno es:  Línea 1: " +
      carton[0] +
      "-" +
      carton[1] +
      "-" +
  ...
  let change = confirm(
    "Si desea continuar con este cartón pulse aceptar; si desea cambiarlo pulse cancelar."
  );
  if (change === false) {
    carton = [];
    generateCarton();
...
const primerTurno = () => {
  ...
  for (let i = 0; i < carton.length; i++) {
    if (carton[i] === randomNumber) {
      carton[i] = "X";
      alert(
        "¡El número coincide con uno de su cartón! Lo tachamos de su cartón con un X: " +
          carton
      );
    }
  }
...
const siguienteTurno = () => {
  ...
  for (let i = 0; i < carton.length; i++) {
    if (carton[i] === randomNumber) {
      carton[i] = "X";
      alert(
        "¡El número coincide con uno de su cartón! Lo tachamos de su cartón con un X:  Línea 1: " +
          carton[0] +
          "-" +
          carton[1] +
          "-" +
  ...
  if (bingo === true) {
    ...
    if (playAgain === true) {
      ...
      alert(
        "Hasta luego " +
          userName +
          " ! Vuelve para jugar al Bingo cuando quieras."
      );
    }
  }
...
const checkLinea = () => {
  if (
    ...
    alert(
      "¡Líneaaaaaaaaaaaaaaaaaa! Enhorabuena, ha conseguido tachar los 5 primeros números del cartón."
    );
    linea1Checked = true;
    linea2Checked = true;
    linea3Checked = true;
  ...
  if (
    ...
    alert(
      "¡Líneaaaaaaaaaaaaaaaaaa! Enhorabuena, ha conseguido tachar los 5 números centrales del cartón."
    );
    linea1Checked = true;
    linea2Checked = true;
    linea3Checked = true;
  ...
  if (
    ...
    alert(
      "¡Líneaaaaaaaaaaaaaaaaaa! Enhorabuena, ha conseguido tachar los 5 últimos números del cartón."
    );
    linea1Checked = true;
    linea2Checked = true;
    linea3Checked = true;
...
const showPoints = () => {
  if (usedNumbers.length === 15) {
    alert(
      "Ha completado el cartón en el menor número de turnos posible, por lo que gana 1.000 puntos. "
    );
